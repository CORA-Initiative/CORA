...
export default function AccountDetails() {
  ...
  return (
    <div className="p-12 md:px-24 pt-8">
        ...
        <div className="mt-12">
            <button className="px-10 py-1 text-mainColor0 font-bold text-lg outline outline-mainColor0 rounded hover:outline-mainColor4 hover:text-mainColor4">Edit</button>
        </div>
